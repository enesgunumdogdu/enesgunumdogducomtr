...
import { GitHub, ArrowForward, Star, Launch, YouTube, Apple, Build, East } from '@mui/icons-material'
...
function Projects() {
  ...
  const featuredProjects = [
    ...
    },
    {
      ...
      description: 'Educational content on Data Structures and Algorithms. 50K+ views.',
      tags: ['Education', 'DSA'],
      github: null,
      live: 'https://youtube.com/@enesgunumdogdu',
      isYouTube: true,
      badge: { label: '50K+', color: '#ef4444' }
    }
  ]
  ...
  return (
    <Box className="page">
      ...
      <Box className="section">
        ...
        <StaggerChildren style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
      ...
      <Box className="section" sx={{ pt: 2 }}>
        ...
        <ScrollReveal delay={0.1}>
          <Box sx={{ mb: 2 }}>
            <Typography sx={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '0.65rem', color: 'var(--text-dim)', mb: 1.5, letterSpacing: '1px', textTransform: 'uppercase' }}>
              Category
            </Typography>
            <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap' }}>
              {filterCategories.map((filter) => {
                ...
                return (
                  ...
                  >
                    {filter.label} <span style={{ fontSize: '0.65rem', opacity: 0.6, marginLeft: 4 }}>({count})</span>
                  </Box>
                )
              })}
            </Box>
            ...
            <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap' }}>
              <Box
                ...
                sx={{
                  ...
                  background: activeLanguages.includes('all') ? 'var(--accent-glow)' : 'transparent',
                    ...
                    >
                      <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5, mb: 1.5 }}>
                        ...
                        {repo.stargazers_count > 0 && (
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, color: '#fbbf24', flexShrink: 0 }}>
                            <Star sx={{ fontSize: 12 }} />
                            <Typography sx={{ fontSize: '0.7rem', fontFamily: "'JetBrains Mono', monospace" }}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 1 }}>
                        {repo.language && (
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                            ...
                            <Typography sx={{ fontSize: '0.7rem', color: 'var(--text-muted)', fontFamily: "'JetBrains Mono', monospace" }}>
                              {repo.language}
                            </Typography>
                          </Box>
                        )}

                        <Typography sx={{ fontSize: '0.65rem', color: 'var(--text-dim)', fontFamily: "'JetBrains Mono', monospace" }}>
          ...
          >
            <Box>
              ...
              <Typography sx={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
                Check out my GitHub profile or reach out.
              </Typography>
            </Box>
